...
import {
  ...
  subWeeks,
  subYears
} from "./chunk-QSRR67AI.js";
import {
  startOfWeek,
  toDate
} from "./chunk-57SDOAMY.js";
import {
  __commonJS,
  __toESM
} from "./chunk-G3PMV62Z.js";

// optional-peer-dep:__vite-optional-peer-dep:date-fns-tz:react-datepicker:true
var require_vite_optional_peer_dep_date_fns_tz_react_datepicker_true = __commonJS({
  "optional-peer-dep:__vite-optional-peer-dep:date-fns-tz:react-datepicker:true"(exports, module) {
    module.exports = {};
...
function getDateFnsTz() {
  ...
  try {
    dateFnsTz = require_vite_optional_peer_dep_date_fns_tz_react_datepicker_true();
  } catch (_a2) {
    dateFnsTz = null;
  }
  return dateFnsTz;
    ...
    function DatePicker2(props) {
      ...
      _this.handleChange = function() {
        ...
        if (selectsRange) {
          ...
          var _h = value.split(dateFormat.includes(trimmedRangeSeparator) ? rangeSeparator : trimmedRangeSeparator, 2).map(function(val) {
            return val.trim();
          }), valueStart = _h[0], valueEnd = _h[1];
          ...
          if (date || !value) {
            ...
            var navDate = parseDateForNavigation(value, (_f = _this.state.preSelection) !== null && _f !== void 0 ? _f : void 0);
        ...
        if (selectsRange) {
          if (modifyDateType === "start") {
            ...
            if (hasStartRange) {
              ...
              onChange === null || onChange === void 0 ? void 0 : onChange([changedStartDate, null], void 0);
