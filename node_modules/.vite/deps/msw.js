...
async function parseQuery(query) {
  const { parse: parse3 } = await import("./graphql-DHQUK6IA.js").catch((error) => {
...
`));
  ...
  #sendMessage(message2) {
    ...
    if (message2.event) {
      frames.push(`event:${message2.event?.toString()}`);
    }
    ...
    this.#emitter.emit("message", {
      id: message2.id,
      event: message2.event?.toString() || "message",
      data: message2.data,
      frames
    });
  }
